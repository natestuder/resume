...
\section{Contact}
3445 Lake Eastbrook Blvd.
Grand Rapids, MI 49546
USA
~
+1 (616) 389-6126
~
\href{mailto:nathan.studer@dornerworks.com}{nathan.studer\\@dornerworks.com}
%github?
...
C, C++, C\#, Ada, VHDL, Verilog, python, RISC-V Assembly, PPC Assembly, ARM Assembly, Shell Scripting, Javascript, HTML5, CSS
\section{Operating Systems}
Unix, Linux, VxWorks, VxWorks 653, Windows, Xen, seL4, RTEMS, FreeRTOS, NuttX
\section{Architectures}
RISC-V, PPC, ARM, FPGA SoC (Xilinx Zynq, Actel SmartFusion2)
\section{IDEs}
...
Senior Engineer at an engineering services firm with a primary focus on seL4 as a secure hypervisor and FPGA based systems.
\begin{itemize}
...
\item Developed and presented hypervisor training and marketing material for both Xen and seL4.
\item Architected and implemented the software architecture for a seL4 based augmented reality helmet system.
\item Implemented ARM SMMUv2 driver for seL4.
\item Subcontractor PI on DARPA SSITH under Draper, porting software and tooling to a cutting edge secure processor using RISC-V.
\item Performed research into portable heterogenous computing (CPU, GPU, and FPGA) solutions.
\item Designed the FPGA system for a Secure Communications device, providing secure external network and storage access to a host PC over USB.
...
QuartusPro, Vivado, Vitis, Mentor Graphics ModelSim, Mentor Graphics Precision, Synplify.
\section{Other}
...
Hardware Emulation, Virtualization, Computer Vision, Open Source Software/Hardware, Functional Programming, Logic Programming, Artificial Intelligence, Machine Learning.
\end{aside2}
...
\item HMI development:  HTML5 with Javascript; Qt and QML.
...
{DornerWorks}
{Grand Rapids, Michigan}
{\emph{Electrical Engineer (Software)} \\
...
\item Created drivers and board support packages for several custom aviation computer architectures based on the VxWorks and VxWorks 653 operating system.  Drivers included DMA, VME, PCI, SPI, Ethernet, RS-232/422/485, and HDLC.
...
\longentry
{2020}
{\emph{Enabling Device Security with a Formally Verified Microkernel}}
{MicroChip Shields Up! Webinar Series}
{Overview presentation of microkernels and formal verification used by seL4 to provide a
secure base system running on the PolarFire SoC.}
\end{entrylist}
